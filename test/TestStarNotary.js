...
it('lets user1 get the funds after the sale', async() => {
    ...
    await instance.buyAStar(starId, {from: user2, value: balance});
...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    await instance.approve(user2, starId, {from:user1});
    await instance.buyAStar(starId, {from: user2, value: balance, gasPrice:0});
...
it('can add the star name and star symbol properly', async() => {
    let contractName = "Bored Star";
    let contractSymbol = "BOS";
    let instance = await StarNotary.deployed();
